...
如果我们要对一段音频文件进行编辑或者格式转换等操作，就需要用到音频处理软件。常用的音频处理软件有Audition、GoldWave和Audacity等。这些软件都有可视化的操作界面，很容易完成对音频文件的各种处理。但如果我们要批量处理音频文件或者要在自己开发的系统中集成一些音频编辑的功能，亦或需要在没有图形界面的环境下对音频文件进行处理，这时这些音频处理软件就未必能满足要求。而另外一款交互式的音频编辑器SoX，就是为这种情况而生，能轻松的满足这些需求。
...
[voice.mp3](2022-07-01-using_sox/audio/voice_apbsO6G6sF.mp3 "voice")

[music.mp3](2022-07-01-using_sox/audio/music_MdOnxLg20h.mp3)
...
[concat.mp3](2022-07-01-using_sox/audio/concat_jt-d3ozt9z.mp3)
...
[mix.mp3](2022-07-01-using_sox/audio/mix_U7RMrW7YNL.mp3)
...
[merge.mp3](2022-07-01-using_sox/audio/merge_Da92ukDPsM.mp3)
...
[voice-50.mp3](2022-07-01-using_sox/audio/voice-50_vAITylqHl6.mp3)

[voice.mp3](2022-07-01-using_sox/audio/voice_Y-PlP39b6o.mp3)
...
![](2022-07-01-using_sox/image/image_VZILUYuPa-.png)
...
![](2022-07-01-using_sox/image/image_9pJfm7CWbZ.png)
...
![](2022-07-01-using_sox/image/image_W0hpma20Qy.png)
...
![](2022-07-01-using_sox/image/image_Z0-X-hVl9h.png)
...
[noeffect.wav](2022-07-01-using_sox/audio/noeffect_ShFwXkPIpC.wav)

[effect\_speed1.5.wav](2022-07-01-using_sox/audio/effect_speed1.5_UCCqzfm9Rp.wav)

[effect\_tempo1.5.wav](2022-07-01-using_sox/audio/effect_tempo1.5_9AsdUjo2Q-.wav)
...
[effect\_pitch500.wav](2022-07-01-using_sox/audio/effect_pitch500_7iDOa9DyH3.wav)

[effect\_pith-500.wav](2022-07-01-using_sox/audio/effect_pith-500_KAsxvf94n5.wav)

[effect\_speed500c.wav](2022-07-01-using_sox/audio/effect_speed500c_35rEAfhQ8d.wav)

[effect\_speed-500c.wav](2022-07-01-using_sox/audio/effect_speed-500c_8by4Rv7jqs.wav)
...
![](2022-07-01-using_sox/image/image_PnKY2bTkYK.png)
...
![](2022-07-01-using_sox/image/image_Aox102URfZ.png)
...
![](2022-07-01-using_sox/image/spectrogram_0zYdLjDW0u.png)
...
[noise.wav](2022-07-01-using_sox/audio/noise_x9ETds0ajB.wav)

[voice.mp3](2022-07-01-using_sox/audio/voice_Y0NMJlRT4D.mp3)

![](2022-07-01-using_sox/image/image_jWOFaQfsDS.png)
...
[noisyvoice.wav](2022-07-01-using_sox/audio/noisyvoice_fpAHmXFVBh.wav)

![](2022-07-01-using_sox/image/image_DmUvpp5y-7.png)
...
[cleanvoice.wav](2022-07-01-using_sox/audio/cleanvoice_SVfF4itnT_.wav)

[cleanvoice0.3.wav](2022-07-01-using_sox/audio/cleanvoice0.3_DD_A2iEbI1.wav)

![](2022-07-01-using_sox/image/image_SJ5iQa1MP4.png)
